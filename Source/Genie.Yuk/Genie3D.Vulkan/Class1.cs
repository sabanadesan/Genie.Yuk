...
namespace Genie3D.Vulkan
{
    public class Class1
    {
        ...
        private void CreateInstance()
        {
            ...
            list.AddRange(Glfw3.GetRequiredInstanceExtensions().ToArray());
            string[] array1 = { ExtExtensions.DebugReport };
        ...
        private void CreateShaderModules()
        {
            ...
            this.vertShader = CreateShader(@".\Output\Shaders\vert.spv");

            this.fragShader = CreateShader(@".\Output\Shaders\frag.spv");
        }
